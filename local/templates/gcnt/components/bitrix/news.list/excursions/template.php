            ...
            <ul>
				<?foreach($arResult["ITEMS"] as $arItem):?>
                    ...
                    <li class="one_new" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                        <div class="visible_place" data-age-limit="<?=$arItem['PROPERTIES']['AGE_LIMIT']['VALUE']?>">
                            <img
                            ...
                            />
                            <div class="date"><?=$arItem['PROPERTIES']['EVENT_TIME_S']['VALUE']?> - <?=$arItem['PROPERTIES']['EVENT_TIME_E']['VALUE']?></div>
