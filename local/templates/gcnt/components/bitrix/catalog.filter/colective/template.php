                ...
                <?foreach($arItem['LIST'] as $key => $item):?>
                    <div class="filter_element">
                        <input type="radio"
                            ...
                            <?=!empty($arItem['INPUT_VALUE'])?(in_array($key,$arItem['INPUT_VALUE'])?'checked':''):(empty($key)?'checked':'');?>
                               id="<?=Cutil::translit($item,"ru",$arParamsTrans)?>"
                               value="<?=$key?>"
                        >
                        <label for="<?=Cutil::translit($item,"ru",$arParamsTrans)?>">
                            <?=$item?>
                        </label>
                    </div>
                <?endforeach;?>
